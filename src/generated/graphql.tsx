    ...
    Array<
      Maybe<
        { __typename?: 'Launch' } & Pick<
          Launch,
          'launch_date_local' | 'id' | 'mission_name'
        > & {
            links: Maybe<
...
export type LaunchQuery = { __typename?: 'Query' } & {
  launch: Maybe<
    { __typename?: 'Launch' } & Pick<
      Launch,
      'details' | 'id' | 'launch_date_utc' | 'launch_success' | 'mission_name'
    > & {
        links: Maybe<
          { __typename?: 'LaunchLinks' } & Pick<
            LaunchLinks,
        ...
        >
        rocket: Maybe<
          { __typename?: 'LaunchRocket' } & Pick<LaunchRocket, 'rocket_name'>
        >
      }
  >
}

export type LaunchNextQueryVariables = {}

export type LaunchNextQuery = { __typename?: 'Query' } & {
  launchNext: Maybe<
    { __typename?: 'Launch' } & Pick<
      Launch,
      'launch_date_local' | 'id' | 'mission_name'
...
export type LaunchesUpcomingQueryVariables = {
  limit: Maybe<Scalars['Int']>
  offset: Maybe<Scalars['Int']>
}

export type LaunchesUpcomingQuery = { __typename?: 'Query' } & {
  launchesUpcoming: Maybe<
    Array<
      Maybe<
        { __typename?: 'Launch' } & Pick<
          Launch,
          'id' | 'launch_date_local' | 'mission_name'
        > & {
            links: Maybe<
              { __typename?: 'LaunchLinks' } & Pick<
                LaunchLinks,
...
export function useLaunchNextQuery(
  ...
  return ApolloReactHooks.useQuery<LaunchNextQuery, LaunchNextQueryVariables>(
    LaunchNextDocument,
    baseOptions,
  )
}
export function useLaunchNextLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    LaunchNextQuery,
    LaunchNextQueryVariables
  >(LaunchNextDocument, baseOptions)
}
...
/**
 * __useLaunchesUpcomingQuery__
 *
 * To run a query within a React component, call `useLaunchesUpcomingQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchesUpcomingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunchesUpcomingQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useLaunchesUpcomingQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    LaunchesUpcomingQuery,
    LaunchesUpcomingQueryVariables
  >,
) {
  return ApolloReactHooks.useQuery<
    LaunchesUpcomingQuery,
    LaunchesUpcomingQueryVariables
  >(LaunchesUpcomingDocument, baseOptions)
}
export function useLaunchesUpcomingLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    LaunchesUpcomingQuery,
    LaunchesUpcomingQueryVariables
  >,
...
export type LaunchesUpcomingQueryHookResult = ReturnType<
  typeof useLaunchesUpcomingQuery
>
export type LaunchesUpcomingLazyQueryHookResult = ReturnType<
  typeof useLaunchesUpcomingLazyQuery
>
