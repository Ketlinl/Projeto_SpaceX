...
import { Launch, useLaunchNextQuery } from '../generated/graphql'
import LaunchDetail from '../components/LaunchDetail'
import ImageViewer from '../components/ImageViewer'

const LaunchesNextPage: React.FC = () => {
  //para não dar erro colocar o campo id como string
  const { id } = useParams<{ id: string }>()
  const { data, loading } = useLaunchNextQuery({
    variables: { id },
  })
        ...
        {loading ? (
          ...
          <IonGrid fixed>
            <IonRow>
              <IonCol>
                <LaunchDetail
                  launch={data?.launchNext as Launch}
...
export default LaunchesNextPage
